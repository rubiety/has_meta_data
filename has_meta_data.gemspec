...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "has_meta_data.gemspec", "init.rb", "install.rb", "lib/has_meta_data.rb", "MIT-LICENSE", "Rakefile", "README.rdoc", "tasks/has_meta_data_tasks.rake", "test/config/database.yml", "test/has_meta_data_test.rb", "test/models/article.rb", "test/schema.rb", "test/test_helper.rb", "uninstall.rb", "Manifest"]
  s.has_rdoc = true
